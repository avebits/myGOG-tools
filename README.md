...
The second part is to temporarily set a different temp/tmp on another partition/harddrive if C: doesn't have enough space for the bigger game. Works with any application.
